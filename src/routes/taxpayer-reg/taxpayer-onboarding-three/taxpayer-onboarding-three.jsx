...
const TaxPayerOnboardingThree = () => {
  ...
  return (
       ...
       <div className=" p-4 h-full ">
        ...
        {/* first  */}  
          <div className=" flex items-center place-content-end space-x-9">
            ...
            <div className="icon bg-[#F2F2F2] text-tax-blue w-[70px] h-[70px] rounded-full grid place-content-center">
    ...
    <div className="flex place-content-center items-center flex-col space-y-12">
      <label htmlFor="imageUpload" className="w-[250px] h-[350px] bg-[#D9D9D9] relative grid  text-center place-content-center items-center ">
      <img src={RightIndexFinger} alt="SelectedImage" className="w-full h-full object-cover object-center absolute top-0" />
      </label> 
      <div className="w-[70%] pb-5 flex gap-12">
            <button className="text-center bg-[#CED8F2] w-full py-3 text-tax-blue rounded-md text-2xl">
              Retry
            </button>
            <a href="taxpayer-onboarding-four" className="bg-tax-blue w-full py-3 text-white rounded-md text-2xl text-center">
              Confirm
            </a>
          </div>
    </div>
...
export default TaxPayerOnboardingThree;
