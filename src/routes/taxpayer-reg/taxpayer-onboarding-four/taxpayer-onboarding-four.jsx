  ...
  return (
    ...
    <div className="flex place-content-center items-center flex-col space-y-12">
      ...
      <button className="text-center bg-[#CED8F2] w-full py-3 text-tax-blue rounded-md text-2xl">
            ...
            <a href="taxpayer-onboarding-five" className="bg-tax-blue w-full py-3 text-white rounded-md text-2xl text-center">
              Confirm
            </a>
          </div>
    </div>
...
export default TaxPayerOnboardingFour;
