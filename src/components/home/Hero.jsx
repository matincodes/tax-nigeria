      ...
      <div className="text-sm sm:text-base w-full bg-[#0C0E40] text-white flex items-center xl:items-start gap-8 h-fit xl:h-[600px] px-4 sm:px-10 xl:px-0 xl:pl-10 py-8 sm:py-10 ">
        <div className="w-full xl:w-[65%] flex flex-col xl:items-start items-center gap-y-8 sm:gap-y-10">
          <h2 className="text-xl md:text-[30px] lg:text-4xl xl:text-7xl font-semibold relative">
            ...
            <img
              src={vector}
              className="absolute w-[70px] md:w-[150px] xl:w-fit right-[30%] top-2"
              alt=""
            />
          </h2>
          ...
          <div className="flex items-start justify-start gap-x-4">
            ...
            <div className="flex flex-col items-center justify-center">
              <p className="max-w-[150px] flex flex-wrap items-start justify-start text-sm">
                Scan QR code to downloadthe NTS app
              </p>
              <img src={arrow} alt="" />
            </div>
          </div>
      ...
      <div className="flex text-black my-8 flex-col md:flex-row items-center justify-center md:items-center md:justify-start gap-5 px-4 sm:px-8 md:px-10">
        <div className="flex items-center md:items-start flex-col justify-center md:justify-start gap-y-3">
          ...
          <p className="text-sm sm:text-base md:text-lg">
            Manage taxes effortlessly. Pay taxes for zero fees, anytime,
            anywhere, with lightning-speed transfers.
          </p>
        </div>
        <img src={clap} alt="" />
      </div>
