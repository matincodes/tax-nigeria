...
const columns = [
  ...
  },
  {
    ...
    cell: ({ row }) => <>{row.getValue('consultant')?.companyName}</>,
  },
  {
...
const StationManagement = () => {
  ...
  const [taxStaions, setTaxStaions] = useState([])
  ...
  return (
    <div className='mt-10 p-4'>
      ...
      <div className='pl-3'>
        <DataTable data={taxStaions} columns={columns} loading={loading} />
      </div>
    </div>
  )
}
