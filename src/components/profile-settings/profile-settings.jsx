          ...
          <div className='col-span-full flex items-center flex-col p-4 space-y-7'>
            ...
            <div className='w-[90%] flex items-center space-x-3'>
              <div className='rounded-full w-[100px] h-[100px] border-2 border-dashed border-[#00000067] grid place-content-center relative'>
                <img
                  ...
                  alt=''
                  srcSet=''
                  className='w-[100px] h-[100px] rounded-full object-cover object-center p-2 '
                />
              </div>

              <label
                htmlFor='file-upload'
                className='relative cursor-pointer border border-[#D0D5DD] focus:border-2 pt-2 pb-2 pl-5 pr-5 mb-1 rounded-xl font-semibold'
              >
                <span className='flex items-center'>
                  <img src={UploadBtn} alt='' className='mr-2' /> Upload
                </span>
                <input
                  id='file-upload'
                  name='file-upload'
            ...
            <div className='w-[90%] flex space-x-4'>
              <div className='basis-[80%] space-y-2'>
                <label
                  htmlFor='fullName'
                  className='text-[18px] text-[#4C4C4C]'
                >
                  Full Name
                </label>
                <input
                  ...
                  name='fullName'
                  readOnly
                  placeholder='Abdulmatin Adeniji'
                  id='fullName'
                  className='border border-[#E6E6E6] w-full outline-none p-3'
                />
              </div>
              <div className='basis-[30%] flex items-end place-items-start'>
                <button
                  type='button'
                  className=' border border-[#D0D5DD] focus:border-2 pt-2 pb-2 pl-4 pr-4 mb-1 rounded-xl font-semibold'
                >
                  Edit
                </button>
              </div>
            ...
            <div className='w-[90%] flex space-x-4'>
              <div className='basis-[80%] space-y-2'>
                <label htmlFor='Email' className='text-[18px] text-[#4C4C4C]'>
                  Email Address
                </label>
                <input
                  type='email'
